...
FP→int quantization (``fused_quantize_*``, ``_grouped_*_quant``,
``fused_quant_kernel``, ``fused_quant_bipolar_batched_kernel``) lives in
:mod:`scmp_kernels.quant`. It is re-exported from this module under its
original names so existing external callers (e.g. ``scmp_diffusion``'s
``optimization_workspace/sc_patch.py``) keep working unchanged.
"""
...
# FP→int quant (and its grouped variants) lives in scmp_kernels.quant.
# Re-export under the original names for backward compatibility — callers
# importing these from ``scmp_kernels.sc.kernels`` continue to work.
from ..quant import (
    fused_quant_kernel,
...
# =============================================================================
# Fused Quantization Kernels — moved to scmp_kernels.quant.fused
# (re-exported at module top so existing imports keep working).
# =============================================================================
...
# (fused_quant_bipolar_batched_kernel moved to scmp_kernels.quant.fused;
...
# =============================================================================
# Grouped PyTorch quant (_grouped_symmetric_quant, _grouped_asymmetric_quant)
# moved to scmp_kernels.quant.grouped — re-exported at module top.
# =============================================================================
...
# =============================================================================
# Batched per-row-group symmetric quant (_grouped_symmetric_quant_batched)
# moved to scmp_kernels.quant.grouped — re-exported at module top.
# =============================================================================
